...
#MODEL_PATH = "Test_lambda_smoothness_snn_regression_final.pth"
#MODEL_PATH = "Test_unfreezed_differential_snn_regression_final.pth"
MODEL_PATH = "450Test_unfreezed_differential_snn_regression_final.pth"
...
def plot_regression_results(model, loader, device):
    ...
    plt.tight_layout()
    plt.savefig("450_Test_Smooth_SNN_Regression_Analysis.png")
